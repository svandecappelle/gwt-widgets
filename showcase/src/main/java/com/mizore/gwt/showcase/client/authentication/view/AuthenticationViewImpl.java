package com.mizore.gwt.showcase.client.authentication.view;
...
public class AuthenticationViewImpl extends PopupPanel implements AuthenticationDisplay {
	...
	public AuthenticationViewImpl() {
		...
		credentialsContainer.add(loginButton);
