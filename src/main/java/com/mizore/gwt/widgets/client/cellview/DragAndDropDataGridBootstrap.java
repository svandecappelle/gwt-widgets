 ...
 */
public class DragAndDropDataGridBootstrap<T> extends DragAndDropDataGrid<T> implements HasStyle, IsResponsive {
     ...
     * @author ohashi keisuke
     */
    public interface Resources extends com.google.gwt.user.cellview.client.DataGrid.Resources, DragAndDropDataGrid.Resources {
