...
import com.mizore.gwt.widgets.client.layout.LayoutVisible.Alignment;
 ...
 * </pre>
 */
public class LayoutVisiblePanel extends ComplexPanel implements AnimatedVisibleLayout,
    RequiresResize, ProvidesResize {

  private final LayoutVisible layout;
  private final LayoutVisibleCommand layoutCmd;

  /**
   * Creates an empty layout panel.
   */
  public LayoutVisiblePanel() {
    setElement(Document.get().createDivElement());
    layout = new LayoutVisible(getElement());
    layoutCmd = new LayoutVisibleCommand(layout);
  }
  ...
  /**
   * Gets the {@link LayoutVisible} instance associated with this widget. This is made
   * package-protected for use by {@link RootLayoutPanel}.
   * 
   * @return this widget's layout instance
   */
  LayoutVisible getLayout() {
    return layout;
  }
  ...
  private LayoutVisible.Layer getLayer(Widget child) {
    assert child.getParent() == this : "The requested widget is not a child of this panel";
    return (LayoutVisible.Layer) child.getLayoutData();
  }
